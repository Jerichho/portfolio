...
export const featuredProjects: Project[] = [
  {
    ...
    description:
      "Senior capstone AI-powered oral exam grading system with separate teacher and student workflows.",
    highlights: [
      "Teacher dashboard architecture and SPA-style navigation",
      "Login/signup UI, role selection, and Manage Students flow",
      "Exams, Analytics, Settings, and Notifications pages",
      "Quick actions and resizable/collapsible sidebar",
      "Exam management UI, UI debugging, and API testing",
    ],
    technologies: [
      "Python",
      "FastAPI",
